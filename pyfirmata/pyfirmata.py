...
class Board(object):
    ...
    def get_pin(self, pin_def, pinchangecallback=None):
        """
        ...
        pin.set_callback(pinchangecallback)
        return pin
        ...
        if self.reporting:
            for pin in self.pins:
                if pin.mode is INPUT:
                    ...
                    if pin.pinchangecallback:
                       pin.pinchangecallback()					
...
class Pin(object):
    ...
    def set_callback(self, pinchangecallback):
         self.pinchangecallback = pinchangecallback
